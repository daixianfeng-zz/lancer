;(function(){
	...
	if ( typeof define === "function" && define.amd ) {
	    define( 'gInput', ['require', 'jquery', 'gMoney'], function(require) {
	        factory(require('jquery'), require('gMoney'));
	        return gInput;
	    } );
	    ...
	    factory(window.jQuery, window.gMoney);
	}
	function factory($, gMoney){
		...
		var onInput = function(jInput, checkFn, inputFn){
			jInput.on('keyup', function(e){
