;(function(){
    ...
    if ( typeof define === "function" && define.amd ) {
        define( 'gTips', ['require', 'jquery', 'G', 'gDialog', 'gToast'], function(require) {
            factory(require('jquery'), require('G'), require('gDialog'), require('gToast'));
            return gTips;
        } );
        ...
        factory(window.jQuery, window.G, window.gDialog, window.gToast);
    }
    function factory($, G, gDialog, gToast){
