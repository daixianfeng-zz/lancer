    ...
    function factory($, G) {
        ...
        Keyboard = function(el, opt) {
            ...
            this.config = $.extend({}, {
                ...
                btnClose: '关闭',
                btnBack: '后退',
                output: function(num) { console.log(num);return false; },
                back: function() { console.log('back');return false; },
        ...
        Keyboard.prototype = {
            ...
            focusArea: function(area){
                if(area){
                    $('.keyboard-ready').removeClass('keyboard-ready');
                    $(area).addClass('keyboard-ready');
                }
                return $('.keyboard-ready').first();
            },
            open: function() {
                $(this.el).show();
                this.rePos();
